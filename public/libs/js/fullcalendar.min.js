...
(function(t) {
    ...
    function o(e) {
        function n(n, r) {
            t.isPlainObject(r) && t.isPlainObject(e[n]) && !i(n)
                ? (e[n] = o({}, e[n], r))
                : void 0 !== r && (e[n] = r);
        }
    ...
    function s(n, r) {
        ...
        function d() {
            ce &&
                (Q("viewDestroy", ce, ce, ce.element),
        ...
        function p(e) {
            ye++,
                ce &&
                    ...
                    $(),
                    ce.element.remove(),
                    oe.deactivateButton(ce.name)),
                oe.activateButton(e),
                (ce = new _e[e](
                    t("<div class='fc-view fc-view-" + e + "' />").appendTo(se),
                    te
                )),
                g(),
                V(),
        ...
        function g(t) {
            (ce.start && !t && fe.isWithin(ce.intervalStart, ce.intervalEnd)) ||
                (f() && m(t));
        }
        function m(t) {
            ye++,
        ...
        function b() {
            ue = ne.contentHeight
                ? ne.contentHeight
                : ne.height
                ? ne.height - (ie ? ie.height() : 0) - T(se)
                : Math.round(se.width() / Math.max(ne.aspectRatio, 0.5));
        }
        function D() {
            void 0 === ue && b(),
                ye++,
                ...
                if (ce.start) {
                    ...
                    setTimeout(function() {
                        e == me &&
                            ...
                            f() &&
                            de != (de = n.outerWidth()) &&
                            (ye++, y(), ce.trigger("windowResize", ge), ye--);
        ...
        function F() {
            var t = te.getNow();
            t.isWithin(ce.intervalStart, ce.intervalEnd)
                ? oe.disableButton("today")
                : oe.enableButton("today");
        }
        function N(t, e) {
            ce.select(t, e);
        }
        ...
        function Q(t, e) {
            return ne[t]
                ? ne[t].apply(e || ge, Array.prototype.slice.call(arguments, 2))
                : void 0;
        }
        function J(e, n) {
            var r = e.target,
            ...
            if (!a.parents(".fc").length) {
                var o = ne.dropAccept;
                (t.isFunction(o) ? o.call(r, a) : a.is(o)) &&
                    ((ve = r), ce.dragStart(ve, e, n));
            }
        }
        function K(t, e) {
        ...
        if (
            (ne.monthNames && (re._months = ne.monthNames),
            ne.monthNamesShort && (re._monthsShort = ne.monthNamesShort),
            ne.dayNames && (re._weekdays = ne.dayNames),
            ne.dayNamesShort && (re._weekdaysShort = ne.dayNamesShort),
            null != ne.firstDay)
        ) {
            var ae = u(re._week);
            (ae.dow = ne.firstDay), (re._week = ae);
        }
        (te.defaultAllDayEventDuration = e.duration(
            ne.defaultAllDayEventDuration
        )),
            (te.defaultTimedEventDuration = e.duration(
            ...
            (te.moment = function() {
                ...
                return (
                    "local" === ne.timezone
                        ? ((t = Re.moment.apply(null, arguments)),
                          t.hasTime() && t.local())
                        : (t =
                              "UTC" === ne.timezone
                                  ? Re.moment.utc.apply(null, arguments)
            ...
            (te.getEventEnd = function(t) {
                return t.end
                    ? t.end.clone()
                    : te.getDefaultEventEnd(t.allDay, t.start);
            }),
            (te.getDefaultEventEnd = function(t, e) {
                var n = e.clone();
                return (
                    t
                        ? n.stripTime().add(te.defaultAllDayEventDuration)
                        : n.add(te.defaultTimedEventDuration),
            ...
            (te.formatRange = function(t, e, n) {
                return (
                    "function" == typeof n && (n = n.call(te, ne, re)),
                    I(t, e, n, null, ne.isRTL)
                );
            }),
            (te.formatDate = function(t, e) {
                return (
                    "function" == typeof e && (e = e.call(te, ne, re)), B(t, e)
                );
            }),
            c.call(te, ne);
        var oe,
                            ...
                            if ("title" == i)
                                ...
                                if (
                                    ...
                                    var h = t(
                                        ...
                                        .click(function() {
                                            h.hasClass(f + "-state-disabled") ||
                                                s();
                                        })
                                        .mousedown(function() {
                                            h.not("." + f + "-state-active")
                                                .not(
                                                    "." + f + "-state-disabled"
                                                )
    ...
    function c(e) {
        function n(t, e) {
            return (
                !E ||
                t.clone().stripZone() < E.clone().stripZone() ||
                e.clone().stripZone() > S.clone().stripZone()
            );
        }
        function r(t, e) {
            (E = t), (S = e), (O = []);
        ...
        function o(n, r) {
            ...
            for (a = 0; s.length > a; a++) {
                if (
                    ((i = s[a].call(C, n, E.clone(), S.clone(), e.timezone, r)),
                    i === !0)
                )
                    return;
            ...
            if (l)
                t.isFunction(l)
                    ? (y(),
                      l.call(C, E.clone(), S.clone(), e.timezone, function(t) {
                          r(t), b();
                      }))
                    : t.isArray(l)
                    ? r(l)
                    ...
                    p && (h[p] = E.format()),
                        ...
                        t.ajax(
                            t.extend({}, He, n, {
                                ...
                                error: function() {
                                    Y(f, this, arguments), r();
                                },
                                complete: function() {
                                    Y(v, this, arguments), b();
                                }
                            })
                        );
                } else r();
        ...
        function p(t, e) {
            ...
            n &&
                (n.source ||
                    (e && (R.events.push(n), (n.source = R)), O.push(n)),
                M(O));
        }
        function g(e) {
            var n;
            if (e) {
                ...
                for (O = t.grep(O, e, !0), n = 0; _.length > n; n++)
                    t.isArray(_[n].events) &&
                        (_[n].events = t.grep(_[n].events, e, !0));
        ...
        function D(n, r) {
            ...
            return (
                ...
                a.isValid() &&
                ((o = null), !n.end || ((o = C.moment(n.end)), o.isValid()))
                    ? ((i = n.allDay),
                      void 0 === i &&
                          ((s = A(
                              r ? r.allDayDefault : void 0,
                              e.allDayDefault
                          )),
                          (i =
                              void 0 !== s
                                  ? s
                                  : !(a.hasTime() || (o && o.hasTime())))),
                      i
                          ? (a.hasTime() && a.stripTime(),
                            o && o.hasTime() && o.stripTime())
                          : (a.hasTime() || (a = C.rezoneDate(a)),
                            o && !o.hasTime() && (o = C.rezoneDate(o))),
                      t.extend(l, n),
                      r && (l.source = r),
                      (l._id =
                          n._id ||
                          (void 0 === n.id ? "_fc" + Fe++ : n.id + "")),
                      ...
                      (l.start = a),
                      (l.end = o),
                      e.forceEventDuration && !l.end && (l.end = z(l)),
                      d(l),
                      l)
                    : void 0
            );
        ...
        function w(t, e, n) {
            ...
            return (
                ...
                r &&
                    (e && (e = e.clone().stripTime()),
                    n && (n = n.clone().stripTime())),
                e && (a = r ? v(e, l.clone().stripTime()) : v(e, l)),
                r != s
                    ? (d = !0)
                    : n &&
                      (o = v(
                          n || C.getDefaultEventEnd(r, e || l),
                          e || l
                      ).subtract(v(c || C.getDefaultEventEnd(s, l), l))),
                (i = T(m(t._id), d, r, a, o)),
                { dateDelta: a, durationDelta: o, undo: i }
            );
        }
            ...
            return (
                t.each(n, function(t, n) {
                    var c = n._allDay,
                        ...
                        p = !r && f ? f.clone() : null;
                    v
                        ? (h.stripTime(), p && p.stripTime())
                        : (h.hasTime() || (h = C.rezoneDate(h)),
                          p && !p.hasTime() && (p = C.rezoneDate(p))),
                        p ||
                            (!e.forceEventDuration && !+i) ||
                            (p = C.getDefaultEventEnd(v, h)),
                        h.add(o),
                        p && p.add(o).add(i),
    ...
    function p(e, n, r) {
        e.unbind("mouseover").mouseover(function(e) {
            ...
            void 0 !== (o = a._fci) &&
                ((a._fci = void 0),
                (i = n[o]),
                r(i.event, i.element, i),
                t(e.target).trigger(e)),
                e.stopPropagation();
        });
    }
    function g(e, n, r) {
    ...
    function O(n, r, a) {
        ...
        return (
            e.isMoment(c)
                ? ((l = e.apply(null, n)),
                  c._ambigTime && (l._ambigTime = !0),
                  c._ambigZone && (l._ambigZone = !0))
                : h(c) || void 0 === c
                ? (l = e.apply(null, n))
                : ((o = !1),
                  (i = !1),
                  d
                      ? Ye.test(c)
                          ? ((c += "-01"), (n = [c]), (o = !0), (i = !0))
                          : (s = Ae.exec(c)) && ((o = !s[5]), (i = !0))
                      : t.isArray(c) && (i = !0),
                  (l = r ? e.utc.apply(e, n) : e.apply(null, n)),
                  o
                      ? ((l._ambigTime = !0), (l._ambigZone = !0))
                      : a && (i ? (l._ambigZone = !0) : d && l.zone(c))),
            new W(l)
        );
    }
    function W(t) {
    ...
    function j(t, e) {
        ...
        return "string" == typeof e
            ...
            ? Oe[n]
                ? Oe[n](t)
                : Z(t, n)
            : e.maybe && ((r = P(t, e.maybe)), r.match(/[1-9]/))
            ? r
            : "";
    }
    function I(t, e, n, r, a) {
        return (
            (t = Re.moment.parseZone(t)),
    ...
    function $(t, e, n) {
        ...
        return "string" == typeof n
            ? n
            : (r = n.token) && ((a = We[r.charAt(0)]), a && t.isSame(e, a))
            ? Z(t, r)
            : !1;
    }
    function V(t) {
    ...
    function U(t, e) {
        ...
        function r(t) {
            ...
            "fixed" == a.opt("weekMode") &&
                (a.end.add("weeks", 6 - n), (n = 6)),
    ...
    function G(t, e) {
        ...
        function r(t) {
            (a.intervalStart = t
                ...
                (a.title = e.formatRange(
                    a.start,
                    a.end.clone().subtract(1),
                    a.opt("titleFormat"),
                    " — "
                )),
    ...
    function J(e, n, r) {
        ...
        function u(t) {
            ...
            return (
                ...
                t.isSame(r, "day")
                    ? i.push("fc-today", re + "-state-highlight")
                    : r > t
                    ? i.push("fc-past")
                    : i.push("fc-future"),
                (a +=
        ...
        function f(e) {
            ...
            "variable" == ie("weekMode")
                ? (n = r = Math.floor(o / (1 == U ? 2 : 6)))
                : ((n = Math.floor(o / U)), (r = o - n * (U - 1))),
                B.each(function(e, o) {
                    U > e &&
                        ((a = t(o)),
                        a
                            .find("> div")
                            .css("min-height", (e == U - 1 ? r : n) - T(a)));
                });
        }
        function v(t) {
            (q = t),
    ...
    function ae(n, r, a) {
                ...
                a += "<thead><tr>",
                    Le("weekNumbers")
                        ? ((t = Ve(0, 0)),
                          (e = Qe(t)),
                          Ye
                              ? (e += Le("weekNumberTitle"))
                              : (e = Le("weekNumberTitle") + e),
                          (a +=
        ...
        function u() {
            ...
            for (
                c +=
                    "<tbody><tr><th class='fc-agenda-axis " +
                    i +
                    "'>&nbsp;</th>",
                    n = "",
                    e = 0;
                ...
                (t = Ve(0, e)),
                    ...
                    t.isSame(l, "day")
                        ? o.push(Fe + "-state-highlight", "fc-today")
                        : l > t
                        ? o.push("fc-past")
                        : o.push("fc-future"),
                    (a =
        ...
        function D(t) {
            if (!Le("selectable")) {
                var e = Math.min(
                        xe - 1,
                        Math.floor((t.pageX - $.offset().left - ve) / he)
                    ),
                    n = Ve(0, e),
        ...
        function N(t) {
            ...
            return (
                Le("allDaySlot") && a--,
                a >= 0 &&
                    (n.time(e.duration(Ae + a * be)), (n = r.rezoneDate(n))),
                n
            );
        }
        function Y(t, n) {
            ...
            if (1 == e.which && Le("selectable")) {
                ...
                Re.start(function(t, e) {
                    if ((Z(), t && t.col == e.col && !_(t))) {
                        var r = N(e),
                            a = N(t);
                        (n = [r, r.clone().add(be), a, a.clone().add(be)].sort(
                            x
                        )),
                            L(n[0], n[3]);
                    } else n = null;
            ...
            Re.start(function(t) {
                if ((Pe(), t)) {
                    var e = N(t),
                        n = e.clone();
                    e.hasTime()
                        ? (n.add(r.defaultTimedEventDuration), E(e, n))
                        : (n.add(r.defaultAllDayEventDuration), w(e, n));
                }
            }, e);
        }
        function I(t, e, n) {
            var r = Re.stop();
            Pe(), r && Ze("drop", t, N(r), e, n);
        }
        var q = this;
        (q.renderAgenda = o),
            (q.setWidth = v),
    ...
    function oe() {
        ...
        function a(t) {
            ...
            for (n = 0; s > n; n++)
                for (
                    e = _(0, n),
                        i = o(t, e.clone().time(l), e.clone().time(c)),
                        i = ie(i),
                        r = 0;
                    i.length > r;
                    r++
        ...
        function i(e, n) {
            ...
            for (r = 0; R > r; r++)
                (a = e[r]),
                    ...
                    F
                        ? ((b = u - a.backwardCoord * f), (m = b - g))
                        : ((m = d + a.backwardCoord * f), (b = m + g)),
                    (m = Math.max(m, d)),
                    (b = Math.min(b, u)),
                    (g = b - m),
                    (a.top = i),
            ...
            for (p(H, e, l), r = 0; R > r; r++)
                (a = e[r]),
                    (w = a.element) &&
                        ((a.vsides = T(w, !0)),
                        (a.hsides = y(w, !0)),
                        (S = w.find(".fc-event-title")),
                        S.length && (a.contentTop = S[0].offsetTop));
            for (r = 0; R > r; r++)
                (a = e[r]),
                    (w = a.element) &&
                        ((w[0].style.width =
                            Math.max(0, a.outerWidth - a.hsides) + "px"),
                        (x = Math.max(0, a.outerHeight - a.vsides)),
                        (w[0].style.height = x + "px"),
                        (o = a.event),
                        void 0 !== a.contentTop &&
                            10 > x - a.contentTop &&
                            (w
                                ...
                                .text(
                                    Q(o.start, v("timeFormat")) +
                                        " - " +
                                        o.title
                                ),
                            w.find("div.fc-event-title").remove()),
                        h("eventAfterRender", o, o, w));
        }
        function s(t, e) {
            var n = "<",
                r = t.url,
            ...
            n.draggable({
                ...
                stop: function(r, o) {
                    if ((d.stop(), $(), h("eventDragStop", n[0], t, r, o), i))
                        ...
                        c ||
                            ((u = Math.round(
                                (n.offset().top - L().offset().top) / b
                            )),
                            (l = e.duration(f + u * y)),
                            (v = G.rezoneDate(v.clone().time(l)))),
                            j(n[0], t, v, r, o);
                    }
                }
            });
            ...
            e.draggable({
                ...
                drag: function(n, a) {
                    ...
                    if ((s = !!f)) {
                        if (
                            ((c = x(f)),
                            (u = Math.round((a.position.left - o.left) / C)),
                            u != p)
                        ) {
                            var v = _(0, i.col),
                                h = i.col + u;
                    ...
                    (s != l || c != d || u != p || m != y) &&
                        (c
                            ? ((b = t.start
                                  ...
                                  .stripTime()
                                  .add("days", g)),
                              (D = b.clone().add(G.defaultAllDayEventDuration)))
                            : ((b = t.start
                                  .clone()
                                  .add(m * S)
                                  .add("days", g)),
        ...
        function u(t, e, n) {
            ...
            e.resizable({
                ...
                resize: function(l, c) {
                    if (
                        ((r = Math.round(
                            (Math.max(i, e.height()) - c.originalSize.height) /
                                i
                        )),
                        r != a)
                    ) {
                        ...
                        var d;
                        (d = r
                            ? f.getEventTimeText(t.start, o)
                            : f.getEventTimeText(t)),
                            n.text(d),
                            (a = r);
                    }
                },
        ...
        if (void 0 === t.forwardCoord)
            for (
                a.length
                    ? (a.sort(he),
                      de(a[0], e + 1, n),
                      (t.forwardCoord = a[0].backwardCoord))
                    : (t.forwardCoord = 1),
                    t.backwardCoord =
    ...
    function ge(n, r, a) {
        ...
        function s(t, e) {
            return r.trigger.apply(
                r,
                [t, e || H].concat(Array.prototype.slice.call(arguments, 2), [
                    H
                ])
            );
        }
        ...
        function E(t) {
            var e = H.start.day();
            return (
                (t += P[e]), 7 * Math.floor(t / L) + j[((t % L) + L) % L] - e
            );
        }
        function S(t) {
        ...
        function M(t) {
            var e = H.start.day();
            return (
                (t += e), Math.floor(t / 7) * L + P[((t % 7) + 7) % 7] - P[e]
            );
        }
        function R(t) {
            var e = H.getColCnt(),
        ...
        (H.getEventTimeText = function(t) {
            ...
            return (
                2 === arguments.length
                    ...
                    : ((e = t.start), (n = t.end)),
                n && o("displayEventEnd")
                    ? r.formatRange(e, n, o("timeFormat"))
                    : r.formatDate(e, o("timeFormat"))
            );
        }),
            (H.isHiddenDay = b),
            (H.skipHiddenDays = w),
        ...
        function u(t) {
            for (var e, n = O(), r = W(), a = [], o = f(t), i = 0; n > i; i++) {
                ...
                for (var c = 0; s.length > c; c++) {
                    var d = s[c];
                    for (
                        d.top = M(l.slice(d.leftCol, d.rightCol + 1)),
                            e = d.leftCol;
                        d.rightCol >= e;
                        e++
                    )
    ...
    function Ee(e) {
        function n(t) {
            ...
            (Boolean(n) !== Boolean(i) ||
                (n && (n.row != i.row || n.col != i.col))) &&
                (n
                    ? (o || (o = n), a(n, o, n.row - o.row, n.col - o.col))
                    : a(n, o),
                (i = n));
        }
        var r,
    ...
    function ke(t) {
        ...
        (n.left = function(t) {
            ...
            (n.right = function(t) {
                return (o[t] =
                    void 0 === o[t] ? n.left(t) + e(t).width() : o[t]);
            }),
            (n.clear = function() {
                (r = {}), (a = {}), (o = {});
            });
    ...
    var xe = {
        ...
        Me = { en: { columnFormat: { week: "ddd M/D" } } },
        ze = {
        ...
        Re = (t.fullCalendar = { version: "2.0.1" }),
        _e = (Re.views = {});
        ...
        (Re.datepickerLang = function(e, n, r) {
            ...
            a || (a = Me[e] = {}),
                o(a, {
                    ...
                    titleFormat: {
                        month: r.showMonthAfterYear
                            ? "YYYY[" + r.yearSuffix + "] MMMM"
                            : "MMMM YYYY[" + r.yearSuffix + "]"
                    },
                    defaultButtonText: {
                        prev: _(r.prevText),
                        next: _(r.nextText),
                ...
                t.datepicker &&
                    ((t.datepicker.regional[n] = t.datepicker.regional[e] = r),
                    (t.datepicker.regional.en = t.datepicker.regional[""]),
                    t.datepicker.setDefaults(r));
        }),
